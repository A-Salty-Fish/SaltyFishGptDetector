...
def init_classifier(model_path='./radar_vicuna_ft_adt/checkpoint-905/'):
    classifier = pipeline("sentiment-analysis", model=model_path,
                          tokenizer=AutoTokenizer.from_pretrained("TrustSafeAI/RADAR-Vicuna-7B", trust_remote_code=True,
                                                                  max_length=512))
    return classifier
...
if __name__ == '__main__':
    ...
    moe_train_files = [
        ...
        # '../my_detector/roberta_test/data/hc3_row.train',
        # '../my_detector/roberta_test/data/hc3_mix_multi_prompt.train'
    ]

    train(model, tokenizer, moe_train_files, 'radar_vicuna_ft_moe_4')
    ...
    # classify_is_human(model, tokenizer, "hello, my name is chatgpt. what can i help you. ")
    pass