...
if __name__ == '__main__':
    ...
    with open('../data_collector/test_data/hc3_english/finance.jsonl', 'r', encoding='utf-8') as in_f:
        i = 0
        for line in in_f:
            i+=1
            if i>10:
            ...
            human_text = json_obj['human_answers'][0]
            ai_text = json_obj['chatgpt_answers'][0]
